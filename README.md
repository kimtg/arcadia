...
## Library
`++ -- <= = > >= abs and append caar cadr cddr def do do1 each for idfn isa isnt join len let list map map1 no nthcdr number or pair positive quasiquote reduce reverse rreduce sref uniq unless w/uniq when with withs`
